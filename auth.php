...
<header class="p-3 mb-3 border-bottom">
  ...
  <div class="container mt-4">
      ...
      <div class="col">
      <h1 class="f">Форма авторизации</h1>
    <form class="f" action="checkauth.php" method="post">
       <p><input type="text" class="form--control" name="login" id="login" placeholder="Логин"><br></p>
        <p><input type="password" class="form--control" name="pass" id="pass" placeholder="Введите пароль" ><br></p>
        <button class="btn btn-success" type="submit">
        <h1 class="f"> Войти</h1>
        </button>
    </form>
    </div>
    <h1 class="f"><a href="reg.php">Зарегестрироваться</a></h1>
